...
const Button = ({icon, text, iconStyle, textStyle} : ButtonProps) => {
    
    return (
        <button className={`flex box-border border border-none rounded-md py-3 px-3 bg-gray-100 hover:${iconStyle?.hoverStyle?.default}`}>
